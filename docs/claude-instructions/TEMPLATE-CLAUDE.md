...
- {{ISSUE_TRACKER_PATH}}: [Absolute path to your issue-tracking-with-ai repo checkout]
...
1. `{{ISSUE_TRACKER_PATH}}/docs/claude-instructions/baton.md` — Read the latest BATON first to understand context
2. `{{ISSUE_TRACKER_PATH}}/docs/claude-instructions/issue-tracking.md` — Register project (first session only), create session, retrieve open issues
3. `{{ISSUE_TRACKER_PATH}}/docs/claude-instructions/git.md` — Verify git is initialized and .gitignore is up to date
